...
def cluster(topics: List, categories: List[str]) -> tuple[List[List], List[str]]:
    ...
    category_keywords = {
        ...
        "Entertainment": ["movie", "film", "music", "celebrity", "actor", "actress", "show", "netflix", "entertainment", "cinema", "streaming", "spotify", "album", "concert", "artist", "awards", "oscar", "grammy", "theater", "theatre", "broadway", "book", "novel", "author", "comic", "anime", "manga", "influencer", "youtuber", "tiktok", "instagram", "podcast", "series", "episode", "director", "singer", "band", "festival", "premiere", "trailer", "hollywood", "bollywood", "gaming", "game", "esports", "twitch", "tv", "video"],
