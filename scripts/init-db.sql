...
-- ============================================================================
-- This script sets up the trend intelligence database from scratch.
-- Run this script once to create the database and initialize the schema.
-- ============================================================================

-- Create database (run this as postgres superuser)
-- Note: This part should be run separately from the schema creation
-- as you cannot create a database from within a connection to that database.

-- Uncomment and run these commands separately if needed:
-- CREATE DATABASE trends;
-- CREATE USER trend_user WITH ENCRYPTED PASSWORD 'trend_password';
-- GRANT ALL PRIVILEGES ON DATABASE trends TO trend_user;

-- ============================================================================
-- Connect to the trends database
-- ============================================================================
...
-- The schema is in a separate file for maintainability
-- \i /path/to/trend_agent/storage/schema.sql

-- For Docker initialization, the schema content is embedded below:
...
-- Grant permissions to trend_user
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'trend_user') THEN
